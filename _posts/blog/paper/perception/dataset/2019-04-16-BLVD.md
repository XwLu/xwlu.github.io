...
<img
src="https://latex.codecogs.com/gif.latex?ADE_{orientation}=\frac{\sum_{i=1}^{N}\sum_{m=1}^{M}\delta&space;_{t}^{i}(1&plus;cos(\theta&space;_{pred}^{i}-\hat&space;{\theta&space;}_{pred}^{i}))}{(N&plus;M)t_{pred}}"/>
